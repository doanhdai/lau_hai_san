...
CREATE TABLE `restaurant_tables`(
	...
	CONSTRAINT `CHK_restaurant_tables_status` CHECK (`status`='CLEANING' OR `status`='OCCUPIED' OR `status`='RESERVED' OR `status`='AVAILABLE'),
	CONSTRAINT `CHK_restaurant_tables_type` CHECK (`type`='OFFLINE' OR `type`='ONLINE')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `restaurant_tables` (`id`, `active`, `capacity`, `location`, `notes`, `status`, `type`, `table_number`, `room_id`) VALUES 
(1, 1, 4, 'Tầng 1 - Khu A', 'Bàn gần cửa sổ', 'AVAILABLE', 'ONLINE', 'T-01', NULL),
(2, 1, 4, 'Tầng 1 - Khu A', NULL, 'AVAILABLE', 'ONLINE', 'T-02', NULL),
(3, 1, 6, 'Tầng 1 - Khu B', NULL, 'AVAILABLE', 'ONLINE', 'T-03', NULL),
(4, 1, 6, 'Tầng 1 - Khu B', NULL, 'AVAILABLE', 'OFFLINE', 'T-04', NULL),
(5, 1, 8, 'Tầng 1 - Khu C', 'Bàn lớn', 'AVAILABLE', 'ONLINE', 'T-05', NULL),
(6, 1, 2, 'Tầng 2 - Khu A', 'Bàn đôi', 'AVAILABLE', 'ONLINE', 'T-06', NULL),
(7, 1, 2, 'Tầng 2 - Khu A', 'Bàn đôi', 'AVAILABLE', 'OFFLINE', 'T-07', NULL),
(8, 1, 4, 'Tầng 2 - Khu B', NULL, 'AVAILABLE', 'ONLINE', 'T-08', NULL),
(9, 1, 4, 'Tầng 2 - Khu B', NULL, 'AVAILABLE', 'OFFLINE', 'T-09', NULL),
(10, 1, 6, 'Tầng 2 - Khu C', NULL, 'AVAILABLE', 'ONLINE', 'T-10', NULL);
