...
function getStatusBadgeClass(status) {
  const classes = {
    ...
    'CHECKED_IN': 'px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800',
    'COMPLETED': 'px-2.5 py-1 rounded-full text-xs font-semibold bg-purple-100 text-purple-800',
